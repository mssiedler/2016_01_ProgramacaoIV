            ...
            <form action="add-ok.jsp" method="post">
                ...
                <div class="mdl-cell--12-col"> 
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        <label class="mdl-textfield__label" for="txtA">Opção A</label>
                    </div>
                </div>
                <div class="mdl-cell--12-col"> 
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" required  id="txtB" />
                        <label class="mdl-textfield__label" for="txtA">Opção B</label>
                    </div>
                </div>
                <div class="mdl-cell--12-col"> 
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" required  id="txtC" />
                        <label class="mdl-textfield__label" for="txtA">Opção C</label>
                    </div>
                </div>
                <div class="mdl-cell--12-col"> 
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input class="mdl-textfield__input" type="text" required  id="txtD" />
                        <label class="mdl-textfield__label" for="txtA">Opção D</label>
                    </div>
                </div>
                <div class="mdl-cell--12-col">
